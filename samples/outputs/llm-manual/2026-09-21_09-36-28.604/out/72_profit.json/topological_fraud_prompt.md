...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T06:29:45.770596Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:45.7723102Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:45.7734141Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "protocol",
          "value" : "AAVE"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:45.7765188Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:45.7775188Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:45.7765188Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T06:29:45.7765188Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:45.7775188Z",
      "id" : "op_3",
      "numericId" : 3,
      "startedAt" : "2026-09-14T06:29:45.7765188Z",
      "wrapperClass" : "io.compprov.examples.nav.wrapped.WrappedAmount"
    ...
    "track" : {
      ...
      "id" : "op_4",
      "numericId" : 4,
      "startedAt" : "2026-09-14T06:29:45.7775188Z",
      "wrapperClass" : "io.compprov.examples.nav.wrapped.WrappedAmount"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_36]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, i_5, o_26]
