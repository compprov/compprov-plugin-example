...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3867803Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3902937Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Computation precision"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3912919Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Lot 1"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3932933Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Lot 1 shares"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3942938Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-03T08:04:34.3952918Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-03T08:04:34.3932933Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-03T08:04:34.3932933Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-03T08:04:34.3942938Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-09-03T08:04:34.3942938Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-03T08:04:34.3952918Z",
      "id" : "op_9",
      "numericId" : 9,
      "startedAt" : "2026-09-03T08:04:34.3942938Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    ...
    "track" : {
      ...
      "id" : "op_10",
      "numericId" : 10,
      "startedAt" : "2026-09-03T08:04:34.3952918Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_9, i_11, i_13, i_1, i_3, i_18, i_2, i_5, i_19]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_22]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [o_4, o_8, o_12, i_18]
