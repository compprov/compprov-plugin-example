...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T06:29:01.0704118Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:01.0729358Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "1.0"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:01.0765018Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:01.0780104Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Subtotal"
      },
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:01.0765018Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T06:29:01.0765018Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:01.0780104Z",
      "id" : "op_5",
      "numericId" : 5,
      "startedAt" : "2026-09-14T06:29:01.0780104Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_6, i_9, i_10, i_12, i_22, i_13, i_24, i_16, i_26, i_19, i_1, i_3, i_2, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_29, o_28]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, o_23, i_24, i_26]
