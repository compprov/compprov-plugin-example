...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T06:29:36.7174215Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "origin",
          "value" : "Binance"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:36.7194189Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "origin",
          "value" : "Binance"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:36.720423Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "source",
          "value" : "Binance"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:36.7214226Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "source",
          "value" : "Binance"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:29:36.7224225Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "BTC amount in USD"
      },
      "id" : "i_10",
      "kind" : "INPUT",
      "numericId" : 10,
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:36.7214226Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T06:29:36.7214226Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:29:36.7224225Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-09-14T06:29:36.7224225Z",
      "wrapperClass" : "io.compprov.examples.nav.wrapped.WrappedAmount"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_6, i_8, i_10, i_1, i_3, i_2, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_15, o_9]
