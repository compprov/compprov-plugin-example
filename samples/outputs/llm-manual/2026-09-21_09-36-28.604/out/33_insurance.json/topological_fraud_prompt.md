...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-03T04:47:51.5886699Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-03T04:47:51.5916759Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Computation precision"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-03T04:47:51.594673Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "claimType",
          "value" : "Collision"
    ...
    "track" : {
      "createdAt" : "2026-09-03T04:47:51.5956748Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-03T04:47:51.594673Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-03T04:47:51.594673Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-03T04:47:51.5956748Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-09-03T04:47:51.5956748Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_6, i_21, i_20, i_12, i_23, i_22, i_14, i_13, i_15, i_29, i_1, i_3, i_2, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_31]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_3, o_28]
