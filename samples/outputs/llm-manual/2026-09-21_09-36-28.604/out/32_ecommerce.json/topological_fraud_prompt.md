...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T06:28:34.9188146Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:34.9208221Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:34.9234157Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:34.9244212Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:34.9254233Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:28:34.9234157Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T06:28:34.9234157Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:28:34.9244212Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-09-14T06:28:34.9244212Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:28:34.9254233Z",
      "id" : "op_6",
      "numericId" : 6,
      "startedAt" : "2026-09-14T06:28:34.9244212Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    ...
    "track" : {
      ...
      "id" : "op_7",
      "numericId" : 7,
      "startedAt" : "2026-09-14T06:28:34.9254233Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_8, i_10, i_20, i_23, i_11, i_14, i_25, i_13, i_17, i_1, i_3, i_2, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_27]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_3, o_24]
