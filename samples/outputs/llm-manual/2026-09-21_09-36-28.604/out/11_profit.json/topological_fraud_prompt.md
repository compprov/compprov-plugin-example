...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T06:28:43.5748833Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:43.575854Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:43.576853Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:43.5800032Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T06:28:43.5815217Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:28:43.5800032Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T06:28:43.5800032Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T06:28:43.5815217Z",
      "id" : "op_11",
      "numericId" : 11,
      "startedAt" : "2026-09-14T06:28:43.5815217Z",
      "wrapperClass" : "io.compprov.examples.nav.wrapped.WrappedAmount"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_35, o_27]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, i_5, o_33]
