...
<CPG>
{
  "descriptor" : {
    "meta" : [ ],
    "name" : "Token sale: minimum purchase gate"
  },
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-08T14:44:15.1786395Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Payment sent (wei)"
      },
      "id" : "i_1",
      "kind" : "INPUT",
      "numericId" : 1,
    ...
    "track" : {
      "createdAt" : "2026-09-08T14:44:15.1846444Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "1 ether, in wei"
      },
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Minimum purchase threshold (whole ether)"
      },
      "id" : "i_3",
      "kind" : "INPUT",
      "numericId" : 3,
    ...
    "track" : {
      "createdAt" : "2026-09-08T14:44:15.1856444Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Payment"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-08T14:44:15.1866441Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Purchase gate decision (payment vs. threshold)"
      },
      "id" : "o_6",
      "kind" : "OUTPUT",
      "numericId" : 6,
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Gate multiplier (1 if payment >= threshold, else 0)"
      },
      "id" : "o_7",
      "kind" : "OUTPUT",
      "numericId" : 7,
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Raw excess payment above threshold (wei)"
      },
      "id" : "o_10",
      "kind" : "OUTPUT",
      "numericId" : 10,
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Excess payment above threshold (wei, bonus-eligible)"
      },
      "id" : "o_11",
      "kind" : "OUTPUT",
      "numericId" : 11,
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-08T14:44:15.1856444Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-08T14:44:15.1846444Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-08T14:44:15.1866441Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-09-08T14:44:15.1856444Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigInteger"
    },
    "arguments" : [ {
      "key" : "a",
    ...
    "track" : {
      ...
      "id" : "op_3",
      "numericId" : 3,
      "startedAt" : "2026-09-08T14:44:15.1866441Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigInteger"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_11]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, i_3, o_5]
