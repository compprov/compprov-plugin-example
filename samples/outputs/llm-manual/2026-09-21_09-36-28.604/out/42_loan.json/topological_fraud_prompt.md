...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-14T07:43:36.8738718Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T07:43:36.8759274Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T07:43:36.8778862Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Extra principal prepayment (non-interest-bearing)"
      },
      "id" : "i_4",
      "kind" : "INPUT",
      "numericId" : 4,
    ...
    "track" : {
      "createdAt" : "2026-09-14T07:43:36.8798426Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-09-14T07:43:36.8813978Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Interest on prepayment [Month 4]"
      },
      "id" : "o_21",
      "kind" : "OUTPUT",
      "numericId" : 21,
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Prepayment principal portion [Month 4]"
      },
      "id" : "o_22",
      "kind" : "OUTPUT",
      "numericId" : 22,
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-14T07:43:36.8798426Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-14T07:43:36.8798426Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-09-14T07:43:36.8813978Z",
      "id" : "op_11",
      "numericId" : 11,
      "startedAt" : "2026-09-14T07:43:36.8813978Z",
      "wrapperClass" : "io.compprov.core.wrappers.WrappedBigDecimal"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_9, i_32, i_13, i_24, i_1, i_3, i_2, i_17, i_28, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_36, o_33, o_31]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, i_3, i_4, i_5, o_6, o_8, o_10, o_12, o_14, o_16, o_18, o_23, o_25, o_27, o_29]
