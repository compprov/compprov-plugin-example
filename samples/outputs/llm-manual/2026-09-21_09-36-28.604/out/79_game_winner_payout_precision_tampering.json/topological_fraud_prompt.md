...
<CPG>
{
  "descriptor" : {
    "meta" : [ ],
    "name" : "Game: winner interest payout"
  },
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-09-08T14:43:24.4747289Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Total game interest (pool)"
      },
      "id" : "i_1",
      "kind" : "INPUT",
      "numericId" : 1,
    ...
    "track" : {
      "createdAt" : "2026-09-08T14:43:24.4797269Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Winner count"
      },
    ...
    "track" : {
      "createdAt" : "2026-09-08T14:43:24.4807269Z",
      "descriptor" : {
        "meta" : [ ],
        "name" : "Per-winner payout"
      },
      "id" : "o_3",
      "kind" : "OUTPUT",
      "numericId" : 3,
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-09-08T14:43:24.4807269Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-09-08T14:43:24.4797269Z",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_1, i_2]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_3]
