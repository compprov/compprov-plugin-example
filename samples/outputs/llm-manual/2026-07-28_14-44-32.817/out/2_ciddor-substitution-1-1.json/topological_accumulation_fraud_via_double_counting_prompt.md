...
- **Leaf variables that share their exact display name (`descriptor.name`) with another variable elsewhere in the graph**: o_81 ("n: refractive index of air (Ciddor / Birch-Downs)") shares its name with: [i_82]
