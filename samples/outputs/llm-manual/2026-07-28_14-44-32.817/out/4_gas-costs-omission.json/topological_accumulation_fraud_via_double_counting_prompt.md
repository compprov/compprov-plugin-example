...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-07-27T09:38:51.7384535Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-07-27T09:38:51.7424577Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "date",
          "value" : "2026-06-30"
    ...
    "track" : {
      "createdAt" : "2026-07-27T09:38:51.7439632Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "protocol",
          "value" : "AAVE"
    ...
    "track" : {
      "createdAt" : "2026-07-27T09:38:51.7464744Z",
      "descriptor" : {
        "meta" : [ ],
    ...
    "track" : {
      "createdAt" : "2026-07-27T09:38:51.7474804Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-07-27T09:38:51.7464744Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-07-27T09:38:51.7464744Z",
    ...
    "track" : {
      ...
      "finishedAt" : "2026-07-27T09:38:51.7474804Z",
      "id" : "op_2",
      "numericId" : 2,
      "startedAt" : "2026-07-27T09:38:51.7474804Z",
      "wrapperClass" : "io.compprov.examples.nav.wrapped.WrappedAmount"
    },
    "arguments" : [ {
      "key" : "a",
...
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_33, o_26]
- **Variable IDs consumed as an argument by more than one operation** (`MathContext` variables, which are legitimately reused across operations, are excluded from this list): [i_2, i_4, o_31]
