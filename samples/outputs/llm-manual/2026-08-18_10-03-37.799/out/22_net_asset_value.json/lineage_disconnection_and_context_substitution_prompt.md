...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-08-05T08:19:33.0846683Z",
      "descriptor" : {
        "meta" : [ {
          "key" : "origin",
          "value" : "Binance"
    ...
    "track" : {
      ...
      "descriptor" : {
        "meta" : [ ],
        "name" : "Assets sum (computed, unused)"
      },
      "id" : "o_14",
      "kind" : "OUTPUT",
      "numericId" : 14,
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-08-05T08:19:33.0846683Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-08-05T08:19:33.0846683Z",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_7, i_6, i_8, i_1, i_15, i_3, i_2, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_14, i_15]
