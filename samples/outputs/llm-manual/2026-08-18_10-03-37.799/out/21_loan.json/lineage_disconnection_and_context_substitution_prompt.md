...
<CPG>
{
  ...
  "variables" : [ {
    "track" : {
      "createdAt" : "2026-08-05T08:19:33.0341473Z",
      "descriptor" : {
        "meta" : [ ],
  ...
  "operations" : [ {
    "track" : {
      ...
      "finishedAt" : "2026-08-05T08:19:33.0341473Z",
      "id" : "op_1",
      "numericId" : 1,
      "startedAt" : "2026-08-05T08:19:33.0341473Z",
...
- **Root variable IDs** (`INPUT` variables with no producing operation): [i_9, i_30, i_31, i_22, i_13, i_1, i_26, i_3, i_2, i_17, i_5, i_4]
- **Leaf variable IDs** (variables never consumed as an argument by any operation): [o_36, o_29, i_31, o_32]
