...
/**
 * Calculates the total charged for a 4-line order.
 *
 * <p>Subtotal = sum(unitPrice × qty). Two discount codes are applied sequentially (compounding).
 * Shipping is taxable. Order total = (discounted subtotal + shipping) × (1 + tax rate).
 */
