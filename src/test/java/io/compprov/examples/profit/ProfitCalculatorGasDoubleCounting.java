 ...
 */
public class ProfitCalculatorGasDoubleCounting {
    ...
    public void calculate() {
        ...
        var wbtcAaveYieldConverted = wbtcAaveYieldInBtc.convert(btcUsdcRate, descriptor("wBTC yield in USDC")).subtract(gasAaveWbtcConverted, descriptor(""));
        var ethAaveYieldConverted = ethAaveYield.convert(ethUsdcRate, descriptor("ETH(AAVE) yield in USDC")).subtract(gasAaveEthConverted, descriptor(""));
        var usdcAaveYieldConverted = usdcAaveYield.subtract(gasAaveUsdcConverted, descriptor(""));
        var usdtMorphoYieldConverted = usdtMorphoYield.convert(usdtUsdcRate, descriptor("USDT(Morpho) yield in USDC")).subtract(gasMorphoUsdtConverted, descriptor(""));
        var ethLidoEtherfiYieldConverted = ethLidoEtherfiYield.convert(ethUsdcRate, descriptor("ETH(Lido+EtherFi) yield in USDC")).subtract(gasLidoConverted, descriptor("")).subtract(gasEtherfiConverted, descriptor(""));
