...
public class ProfitCalculator {
    ...
    public void calculate() {
        ...
        final var wbtcAaveYieldInBtc = wbtcAaveYield.convert(wbtcBtcPegRate, descriptor("wBTC yield in BTC (peg-adjusted)"));
        final var grossYield = wbtcAaveYieldInBtc.convert(btcUsdcRate, descriptor("wBTC yield in USDC"))
                .addBulk(List.of(
