...
/**
 * Runs a 6-month slice of a mortgage amortization schedule.
 *
 * <p>Per month: {@code interest = balance × periodRate}; {@code principalPortion = payment −
 * interest}; {@code balance −= principalPortion}. Month 4 additionally applies a principal-only
 * prepayment directly to the balance. Escrow (property tax + insurance) is collected separately
 * each month and doesn't affect the amortization itself.
 */
