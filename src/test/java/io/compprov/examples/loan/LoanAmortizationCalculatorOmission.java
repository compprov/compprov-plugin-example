...
/**
 * Calculation Omission attack: escrow (property tax + insurance) is collected and correctly
 * labeled every month, and {@code totalEscrowCollected} is computed correctly in its own
 * subgraph — but it's silently dropped from {@code totalOutlay}, understating what the borrower
 * actually paid.
 */
public class LoanAmortizationCalculatorOmission {
    ...
    public void calculate() {
        ...
        // === Total outlay — escrow never added here ===
