...
/**
 * Adjudicates three auto insurance claims (collision, comprehensive, liability) and computes the
 * insurer's net loss after reinsurance recovery.
 *
 * <p>Per-claim payout = {@code min(max(claim − deductible, 0) × coinsuranceRate, policyLimit)}.
 * <p>Net loss = total payout − (total payout × reinsurance recovery rate).
 */
