...
/**
 * Semantic Type and Context Cast attack: the collision claim is adjudicated using the
 * <em>comprehensive</em> policy's deductible, coinsurance rate, and policy limit — all of which
 * are more generous — while every descriptor along that chain still reads "Collision". The graph
 * type-checks and replays perfectly; only the declared policy context is wrong.
 */
public class ClaimsCalculatorSemanticTamper {
    ...
    public void calculate() {
        ...
        // === Comprehensive claim (payout will be capped at the policy limit) ===
        ...
        // === Total payout and reinsurance recovery ===
        ...
        // === Net loss === (tamper here should be subtraction)
        final var netLoss = totalPayout.add(reinsuranceRecovery, mc, descriptor("Net loss"));
