...
public class ClaimsCalculatorPrecisionTampering {
    ...
    public void calculate() {
        ...
        final var comprehensiveCoinsuranceAmount = comprehensiveNetOfDeductible.multiply(comprehensiveCoinsurance, lowPrecisionMc, descriptor("Comprehensive: coinsurance amount"));
